define(['tdui', 'tdDatagrid', 'tdDialog', 'tdForm', 'tdText', 'tdSelect'], function (TD) {
	var opts = {
		$id: 'ex01',
		$qry_form_opt: {
			onsubmited: function(ev, vm) {
				avalon.vmodels['crud01_datagrid'].hideContent();
