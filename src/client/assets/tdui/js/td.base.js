define(['avalon'], function (avalon) {
	...
	(function() {
		...
		_hintEle.innerHTML = '<button type="button" class="close" onclick="_td_close(event, \'hint\')"><span>&times;</span></button><strong></strong>';
		...
		_alertEle.innerHTML = '<div class="modal-dialog modal-sm"><div class="modal-content">' +
			'<div class="modal-header">' +
				'<button type="button" class="close" onclick="_td_close(event, \'alert\')"><span>&times;</span></button>' +
				'<h4 class="modal-title">提示</h4>' +
			'</div>' +
			'<div class="modal-body"></div>' +
			'<div class="modal-footer">' +
				'<button type="button" class="btn btn-primary waves-effect waves-light" onclick="_td_close(event, \'alert\')">确定</button>' +
			'</div>' +
		'</div></div>';
